...
namespace Client
{
	...
	enum class LEVEL { LEVEL_STATIC, LEVEL_LOADING, LEVEL_LOGO, LEVEL_GAMEPLAY,
						...
						LEVEL_FINALBOSS1, LEVEL_FINALBOSS2, LEVEL_FINALBOSS3, LEVEL_ENDING,
						LEVEL_MAPEDIT, LEVEL_DIALOGUE, LEVEL_END };
	...
	enum class STAGEMONERSTATE { IDLE, ATTACK, CHASE, TURN, HIT, FIRE, VIEWTURN, BOOST, DAMAGE, DEAD };
