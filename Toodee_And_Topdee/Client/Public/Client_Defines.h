...
namespace Client
{
	...
	enum class LEVEL { LEVEL_STATIC, LEVEL_LOADING, LEVEL_LOGO, LEVEL_GAMEPLAY,
						...
						LEVEL_STAGE4, LEVEL_STAGE5, LEVEL_STAGE6, 
						LEVEL_FINALBOSS1, LEVEL_FINALBOSS2, LEVEL_FINALBOSS3,
	...
	enum class PLAYERSTATE { IDLE, MOVE, ACTION, SWIM, STOP, CLEAR, DEAD, PLAYERSTATE_END };
	...
	enum class MAPOBJECT { NONE, WALL, WOOD, BREAK, LOCK, FALL, SPARK, METAL, HOLE, KEY, PORTAL, TOPDEE, TOODEE, SPIKE, MAPOBJECT_END };
