...
void CLevel_FinalBoss01::Update(_float fTimeDelta)
{
...
{
	SetWindowText(g_hWnd, TEXT("CLevel_FinalBoss01"));
...
HRESULT CLevel_FinalBoss01::Ready_Layer_Camera(const _wstring& strLayerTag)
{
	...
	if (FAILED(m_pGameInstance->Add_GameObject_ToLayer(ENUM_CLASS(LEVEL::LEVEL_FINALBOSS1), strLayerTag,
		ENUM_CLASS(LEVEL::LEVEL_FINALBOSS1), TEXT("Prototype_GameObject_FPSCam"), &CameraDesc)))
		return E_FAIL;

	return S_OK;
}

HRESULT CLevel_FinalBoss01::Ready_Layer_MapObject(const _wstring& strLayerTag)
{
	m_pGameInstance->Load_File(TEXT("../Resources/Map/FinalBoss1"));
	...
	while (S_OK == (m_pGameInstance->Get_Tile_Data(idx++, info)))
	{
		...
		case MAPOBJECT::WOOD:
			if (FAILED(m_pGameInstance->Add_GameObject_ToLayer(ENUM_CLASS(LEVEL::LEVEL_FINALBOSS1), strLayerTag,
				ENUM_CLASS(LEVEL::LEVEL_FINALBOSS1), TEXT("Prototype_GameObject_WallWood"), &info)))
				return E_FAIL;
			break;

		case MAPOBJECT::BREAK:
			if (FAILED(m_pGameInstance->Add_GameObject_ToLayer(ENUM_CLASS(LEVEL::LEVEL_FINALBOSS1), strLayerTag,
				ENUM_CLASS(LEVEL::LEVEL_FINALBOSS1), TEXT("Prototype_GameObject_WallBreak"), &info)))
				return E_FAIL;
			break;

		case MAPOBJECT::LOCK:
			if (FAILED(m_pGameInstance->Add_GameObject_ToLayer(ENUM_CLASS(LEVEL::LEVEL_FINALBOSS1), strLayerTag,
				ENUM_CLASS(LEVEL::LEVEL_FINALBOSS1), TEXT("Prototype_GameObject_WallLock"), &info)))
				return E_FAIL;
			break;

		case MAPOBJECT::FALL:
			if (FAILED(m_pGameInstance->Add_GameObject_ToLayer(ENUM_CLASS(LEVEL::LEVEL_FINALBOSS1), strLayerTag,
				ENUM_CLASS(LEVEL::LEVEL_FINALBOSS1), TEXT("Prototype_GameObject_WallFall"), &info)))
				return E_FAIL;
			break;
		...
		case MAPOBJECT::METAL:
			if (FAILED(m_pGameInstance->Add_GameObject_ToLayer(ENUM_CLASS(LEVEL::LEVEL_FINALBOSS1), strLayerTag,
				ENUM_CLASS(LEVEL::LEVEL_FINALBOSS1), TEXT("Prototype_GameObject_Metal"), &info)))
				return E_FAIL;
			break;
		...
		case MAPOBJECT::KEY:
			/*if (FAILED(m_pGameInstance->Add_GameObject_ToLayer(ENUM_CLASS(LEVEL::LEVEL_FINALBOSS1), strLayerTag,
				ENUM_CLASS(LEVEL::LEVEL_FINALBOSS1), TEXT("Prototype_GameObject_Key"), &info)))
				return E_FAIL;*/
...
HRESULT CLevel_FinalBoss01::Ready_Layer_Back(const _wstring& strLayerTag)
{
...
HRESULT CLevel_FinalBoss01::Ready_Layer_ColliderMap(const _wstring& strLayerTag)
{
	CColliderMap_Object::COLLIDER_MAP_DESC desc{};

	for (_uint i = 0; i < Stage_ColliderCount(LEVEL::LEVEL_FINALBOSS1); ++i)
	{
		auto Pair = MapCollider_Builder(LEVEL::LEVEL_FINALBOSS1, i);
...
{
	CLevel_FinalBoss01* pInstance = new CLevel_FinalBoss01(pGraphic_Device);

	if (FAILED(pInstance->Initialize()))
	{
		MSG_BOX(TEXT("Failed to Created : CLevel_FinalBoss01"));
